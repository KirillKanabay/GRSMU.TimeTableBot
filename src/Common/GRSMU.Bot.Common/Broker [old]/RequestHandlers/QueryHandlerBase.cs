...
public abstract class QueryHandlerBase<TRequest, TResponse, TContext> : IRequestHandler<TRequest, TResponse>
    where TRequest : QueryMessageBase<TResponse>
...
public abstract class QueryHandlerBase<TRequest, TResponse> : QueryHandlerBase<TRequest, TResponse, NullableContext>
    where TRequest : QueryMessageBase<TResponse>
    where TResponse : ResponseBase, new()
{
}